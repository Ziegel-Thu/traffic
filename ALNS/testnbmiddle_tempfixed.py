...
class VRPPD:
    def __init__(self, num_customers, num_vehicles, demands, vehicle_capacity, distance_matrix, time_windows, penalty_coefficient):
        ...
        self.routes=[[1,2,3,7,8,9,10,11,12,13,17,18,19,20,21],[4,5,6,14,15,16,21],[21]]
...
def ALNS(vrppd, max_iterations=10000, destruction_level=0.3, initial_temperature=100.0, cooling_rate=0.99):
    ...
    while iteration < max_iterations:
        ...
        # Perform repair
        repaired_solution, new_cost, temperature = repair(new_solution, destroyed_customers, vrppd, temperature, cooling_rate)
...
def repair(solution, destroyed_customers, vrppd, temperature, cooling_rate):
    ...
    '''print(temperature)'''
    return best_solution, best_total_cost, temperature
