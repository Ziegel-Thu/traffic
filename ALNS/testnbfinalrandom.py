...
def ALNS(vrppd, max_iterations=1000, destruction_level=0.3, initial_temperature=100.0, cooling_rate=0.99):
    ...
    while iteration < max_iterations:
        ...
        if recent_solutions.count(best_cost) >= identical_solution_threshold:
            ...
            current_solution, new_cost = random_repair(new_solution, destroyed_customers, vrppd)
...
def random_repair(solution, destroyed_customers, vrppd):
    ...
    #print("随机修复后的新解：", new_solution)
    return new_solution, vrppd.total_distance(new_solution) + vrppd.total_penalty(new_solution)
